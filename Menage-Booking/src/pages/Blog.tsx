        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a href="/blog" className={`${isDark ? 'text-blue-500 hover:text-blue-400' : 'text-gray-600 hover:text-gray-900'} transition-colors`}>Blog</a>
          ...
          {menuOpen && (
            <div className="md:hidden py-4 space-y-3 border-t border-gray-800">
              ...
              <a href="/blog" className="block text-blue-500 hover:text-blue-400 transition-colors font-medium">Blog</a>
